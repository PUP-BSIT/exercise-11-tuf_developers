function validateComment() {
    ...
    let comment_message = document.getElementById("message");
    let comment_button = document.getElementById("comment_button");

    if (comment_name.value.length < 1 ||
        comment_message.value.length <1) {
...
document.getElementById("message").addEventListener("input", validateComment);